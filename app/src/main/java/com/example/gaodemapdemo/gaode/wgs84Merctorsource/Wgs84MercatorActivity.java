...
public class Wgs84MercatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wgs84_mecator);
        MapsInitializer.updatePrivacyShow(Wgs84MercatorActivity.this, true, true);
        MapsInitializer.updatePrivacyAgree(Wgs84MercatorActivity.this, true);

        mMapview = ((MapView) findViewById(R.id.wgs84_mercator_mv_map));
        mAppCompatTextView = (AppCompatTextView) findViewById(R.id.wgs84_mercator_tv_zoom_level);
        ...
        initPolygon();
        //加载自定义wms
        Wgs84MecatorTileProvider tileProvider = new Wgs84MecatorTileProvider();
        tileProvider.setContext(Wgs84MercatorActivity.this);
    ...
    private void initPolygon() {
        ...
        polygon = aMap.addPolygon(new PolygonOptions().addAll(latLngs).fillColor(Color.argb(245,
    ...
    private void searchDistrict() {
        ...
        try {
            ...
            districtSearchQuery.setKeywords("420113");//武汉市汉南区
    ...
    private void drawBound(DistrictItem item) {
        ...
        if (holeOptionsList.size() > 0) {
            Wgs84MercatorActivity.ListComparator c =
                    new Wgs84MercatorActivity.ListComparator();
    ...
    private void setUpMap() {
        ...
        final LatLng HANNANQU = new LatLng(30.308776, 114.084582);// 汉南区
        aMap.moveCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(
                HANNANQU, 9, 30, 30)));
        // 设置可视范围变化时的回调的接口方法
