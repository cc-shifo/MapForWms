...
public class MainTianDiTuSrcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tianditu_src);
        MapsInitializer.updatePrivacyShow(MainTianDiTuSrcActivity.this, true, true);
        MapsInitializer.updatePrivacyAgree(MainTianDiTuSrcActivity.this, true);

        mMapview = ((MapView) findViewById(R.id.activity_src_tdt_mv_map));
        mTextView = (TextView) findViewById(R.id.activity_src_tv_zoom_level);
        ...
        // initPolygon();
        //加载自定义wms
        TianDiTuTileProvider tileProvider = new TianDiTuTileProvider();
        tileProvider.setContext(MainTianDiTuSrcActivity.this);
    ...
    private void drawBound(DistrictItem item) {
        ...
        if (holeOptionsList.size() > 0) {
            MainTianDiTuSrcActivity.ListComparator c = new MainTianDiTuSrcActivity.ListComparator();
