...
import com.example.gaodemapdemo.google.MapsActivity;
import com.example.gaodemapdemo.tianditu.TianDiTuMapActivity;
...
public class DifferentMapSDKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_different_map);
        MapsInitializer.updatePrivacyShow(DifferentMapSDKActivity.this, true, true);
        MapsInitializer.updatePrivacyAgree(DifferentMapSDKActivity.this, true);

        mMapview = ((MapView) findViewById(R.id.mv_map));
        findViewById(R.id.acb_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DifferentMapSDKActivity.this, MapsActivity.class));
            }
        });
        ...
        findViewById(R.id.acb_btn_tian).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DifferentMapSDKActivity.this, TianDiTuMapActivity.class));
            }
        });
        findViewById(R.id.amap_with_src_tian_di_tu_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DifferentMapSDKActivity.this,
                        MainTianDiTuSrcActivity.class));
            }
        });

        mAppCompatTextView = (AppCompatTextView) findViewById(R.id.tv_zoom_level);
        ...
        tileProvider.setContext(DifferentMapSDKActivity.this);
