package com.example.gaodemapdemo.google;


import com.google.android.gms.maps.model.UrlTileProvider;
import com.example.gaodemapdemo.gaode.PositionModel;
import com.example.gaodemapdemo.gaode.PositionUtil;
...
public class GoogleHeritageScopeTileProvider extends UrlTileProvider {
    ...
    //默认瓦片大小
    private static final int titleSize = 256;//a=6378137±2（m）
    //基本参数
